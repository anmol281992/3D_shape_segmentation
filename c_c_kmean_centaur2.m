...
fid=fopen('/Users/compume/Documents/MATLAB/COMPUTER_VISION_HW4/computer_vision_HW4/centaur2.off');
fgetl(fid);
...
[maxim,startind] = max(sum((centaur2_hks).^2,2));
index = [startind];
allindex = 1:3400;
...
R1 =repmat(sqrt(sum(centaur2_hks.^2,2)),1,101);
R2 =repmat(sqrt(sum(coord.^2,2)),1,3);
centaur2_hks = centaur2_hks./R1;
coord1 = coord./R2;
measure1 = [lamda*centaur2_hks (1-lamda)*coord1];
